...
namespace Infrastructure.T4
{
	...
	for (int i = 0; i < m_UnityTags.Length; i++)
	{
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(m_UnityTags[i].Replace(" ", "")));
            this.Write(" = \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(m_UnityTags[i]));
            this.Write("\";\r\n");
...
private string[] _m_UnityTagsField;

/// <summary>
/// Access the m_UnityTags parameter of the template.
/// </summary>
private string[] m_UnityTags
{
    get
    {
        return this._m_UnityTagsField;
    }
}
...
bool m_UnityTagsValueAcquired = false;
if (this.Session.ContainsKey("m_UnityTags"))
{
    this._m_UnityTagsField = ((string[])(this.Session["m_UnityTags"]));
    m_UnityTagsValueAcquired = true;
}
if ((m_UnityTagsValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("m_UnityTags");
    if ((data != null))
    {
        this._m_UnityTagsField = ((string[])(data));
    }
}
